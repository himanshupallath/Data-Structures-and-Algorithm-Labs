...
/** This is a helper function I created to help me print out the infix, postfix arrays and
  operator stack during each iteration of the loop
  @param oper the operator stack
  @param postfix the postfix array that holds the postfix expression
*/
void printOperatorAndPostfix(stack<string> oper, string postfix[], string infix[]) {
    stack<string> temp = oper;  // copy of oper stack so that I don't change original stack
    // Prints out the infix array
    cout<<"[";
    for (unsigned int i = 0; i < 23; i++) {
        cout<<infix[i]<<" ";
    }
    cout<<"]"<<endl;
    // Prints out the operator stack
    cout<<"[";
